...
python -u -m main \
  ...
  training.finetune_path="/dataset/david/discrete-mean-flow/text/outputs/synthetic-align/2025.12.22/113516/checkpoints/last.ckpt" \
  +wandb.offline=false
