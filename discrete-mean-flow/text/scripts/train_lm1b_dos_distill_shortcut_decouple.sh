...
DIT_USE_COMPILE=TRUE python -u -m main \
  ...
  sampling.argmax_correction=True \
  ...
  training.finetune_path="/home/david3684/projects/discrete-mean-flow/text/outputs/lm1b/68-950000.ckpt" \