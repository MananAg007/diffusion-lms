...
python -u -m main \
  ...
  wandb.name=dos_owt_full_pretrain_0.1_0.01 \
  model=small \
  algo=dos \
  model.length=1024 \
  ...
  checkpointing.resume_ckpt_path="/dataset/david/discrete-mean-flow/text/outputs/openwebtext-train/2025.12.06/152010/checkpoints/last.ckpt"
